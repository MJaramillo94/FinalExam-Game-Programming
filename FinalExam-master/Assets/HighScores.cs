...
public class HighScores : MonoBehaviour
{
    ...
    public Text highScoreNameDisplay;
    public Text highScoreScoreDisplay;
    ...
    void readHighScores()
    {
        ...
        highScoreNameDisplay.text = playerData[0] + "\n" +
            playerData[1] + "\n" +
            playerData[2] + "\n" +
            playerData[3] + "\n" +
            playerData[4];

        highScoreScoreDisplay.text = scoreData[0] + "\n" +
            scoreData[1] + "\n" +
            scoreData[2] + "\n" +
            scoreData[3] + "\n" +
            scoreData[4];
